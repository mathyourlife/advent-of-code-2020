...
func (d *Day11) SolvePart1() {
	...
	d.mode = "around"
	stabilized := d.stabilize(Day11Content)
...
const Day11Content = `LLLLLLLL.LLLL.LLLLL.LLLLLLLLLLLLLL.LLLLLLLLLLLLLL.LLLLL.LLLLLLLLLLLLLL.LLLLLLL.LLLLLL.LLLLLLLLLL.L
